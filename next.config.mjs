...
const nextConfig = {
  ...
  async rewrites() {
    // Sin backend en prod, el fallback era localhost → proxy roto en Vercel.
    // VERCEL_URL existe en todos los deploys de Vercel; .env.production define BACKEND_INTERNAL_URL en build.
    const backendUrl =
